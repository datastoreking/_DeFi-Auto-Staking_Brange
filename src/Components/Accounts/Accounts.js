  ...
  return (
    <div className="accounts">
        <div className="total_earned">
            ...
            <p className="total_earned_p_share">0.00 Token (0.00% increase)</p>
        </div>
        <div className="apy">
            <div className="apy_box_related">
                ...
                <div className="balance_box">
                    ...
                    <div className='balance_box_div'>
						...
						<div className='balance_box_div_r'>Token</div>
					</div>
                </div>
            </div>
            <div className="apy_box_related_r">
                <p className="apy_box_share">Daily ROI</p>
                <p className="apy_box_share">2.42%</p>
            </div>
        </div>
