  ...
  return (
    <div className="calculator">
        ...
        <div className="titano_price_duplicate">
			...
			<div className='titano_price_duplicate_box'>
				<p className='titano_price_duplicate_title'>Token rewards estimation</p>
				<p className='titano_price_duplicate_value'>{rewardestimation} </p>
			</div>
			<div className='titano_price_duplicate_box'>
